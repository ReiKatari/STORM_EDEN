...
- **Поддерживаемые эмуляторы и форки**: STORM EDEN, Eden, Citron, Yuzu, Suyu, Sudachi, Torzu, Ryujinx

## **Установка и запуск**
1. Перейдите в раздел **Releases** репозитория на GitHub.
2. Для Android: скачайте и установите APK-файл `STORM_EDEN_<версия>.apk` или `STORM_EDEN_<версия>_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_EDEN_<версия>.zip`.
