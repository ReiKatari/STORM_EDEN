...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_6.1.8.apk` или `STORM_SWITCH_6.1.8_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_6.1.8_Windows.zip`.
