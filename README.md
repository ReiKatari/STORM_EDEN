...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_6.1.9.apk` или `STORM_SWITCH_6.1.9_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_6.1.9_Windows.zip`.
