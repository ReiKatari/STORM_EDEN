...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_6.2.0.apk` или `STORM_SWITCH_6.2.0_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_6.2.0_Windows.zip`.
