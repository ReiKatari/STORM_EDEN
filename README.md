...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_<версия>.apk` или `STORM_SWITCH_<версия>_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_<версия>.zip`.
