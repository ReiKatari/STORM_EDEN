...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_6.1.7.apk` или `STORM_SWITCH_6.1.7_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_6.1.7_Windows.zip`.
