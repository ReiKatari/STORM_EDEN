...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_6.2.1.apk` или `STORM_SWITCH_6.2.1_LEGACY.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_6.2.1_Windows.zip`.
