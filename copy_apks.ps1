...
Write-Host "Copying APKs with STORM_SWITCH_7.3.2 naming..."
if (Test-Path $mainline) {
    Copy-Item $mainline 'e:\STORM EDEN 3\Files\STORM_SWITCH_7.3.2.apk' -Force
    Copy-Item $mainline 'e:\STORM EDEN 3\STORM_SWITCH_7.3.2.apk' -Force
}

if (Test-Path $legacy) {
    Copy-Item $legacy 'e:\STORM EDEN 3\Files\STORM_SWITCH_7.3.2_LEGACY.apk' -Force
    Copy-Item $legacy 'e:\STORM EDEN 3\STORM_SWITCH_7.3.2_LEGACY.apk' -Force
}

if (Test-Path $sdk27) {
    Copy-Item $sdk27 'e:\STORM EDEN 3\Files\STORM_SWITCH_7.3.2_SDK27.apk' -Force
    Copy-Item $sdk27 'e:\STORM EDEN 3\STORM_SWITCH_7.3.2_SDK27.apk' -Force
}
