...
Write-Host "Creating Windows 7.2.9 release zip..."
...
$zipPath = 'e:\STORM EDEN 3\Files\STORM_SWITCH_7.2.9_Windows.zip'
if (Test-Path $zipPath) { Remove-Item $zipPath -Force }

& 'C:\Program Files\7-Zip\7z.exe' a -tzip $zipPath "$stageDir\*" -mx=9

Copy-Item $zipPath 'e:\STORM EDEN 3\STORM_SWITCH_7.2.9_Windows.zip' -Force

Remove-Item $stageDir -Recurse -Force

Write-Host "All executables signed, packaged to 7.2.9 zip and copied to root/Files!"
