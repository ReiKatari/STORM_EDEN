...
bool GRenderWindow::InitRenderTarget() {
    ...
    child_widget->show(); // IMPORTANT: child_widget must be explicitly shown since its parent is already visible!
...
void GRenderWindow::CaptureScreenshot(const QString& screenshot_path) {
    ...
    renderer.RequestScreenshot(
        ...
        [=, this](bool invert_y) {
            ...
            const QImage final_image = invert_y ? screenshot_image.flipped(Qt::Vertical) : screenshot_image;
#else
            const QImage final_image = screenshot_image.mirrored(false, invert_y);
#endif
            if (final_image.save(screenshot_path)) {
