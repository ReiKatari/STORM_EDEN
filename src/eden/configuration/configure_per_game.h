...
private:
    ...
    void AsyncMetadataLoaded();

    std::unique_ptr<Ui::ConfigurePerGame> ui;
    FileSys::VirtualFile file;
    u64 title_id;

    QFutureWatcher<AsyncMetadataResult> metadata_watcher;
    ...
    std::unique_ptr<ConfigureGameBanana> gamebanana_tab;
