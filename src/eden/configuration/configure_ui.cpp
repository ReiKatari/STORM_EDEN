...
void ConfigureUi::ApplyConfiguration() {
    ...
    auto new_theme = ui->theme_combobox->itemData(ui->theme_combobox->currentIndex()).toString().toStdString();
    if (UISettings::values.theme != new_theme) {
        UISettings::values.theme = new_theme;
    }

    if (UISettings::values.show_add_ons.GetValue() != ui->show_add_ons->isChecked()) needs_reload = true;
    UISettings::values.show_add_ons = ui->show_add_ons->isChecked();

    if (UISettings::values.show_compat.GetValue() != ui->show_compat->isChecked()) needs_reload = true;
    UISettings::values.show_compat = ui->show_compat->isChecked();

    if (UISettings::values.show_size.GetValue() != ui->show_size->isChecked()) needs_reload = true;
    UISettings::values.show_size = ui->show_size->isChecked();

    if (UISettings::values.show_types.GetValue() != ui->show_types->isChecked()) needs_reload = true;
    UISettings::values.show_types = ui->show_types->isChecked();

    if (UISettings::values.show_play_time.GetValue() != ui->show_play_time->isChecked()) needs_reload = true;
    UISettings::values.show_play_time = ui->show_play_time->isChecked();

    if (UISettings::values.folder_icon_size.GetValue() != ui->folder_icon_size_combobox->currentData().toUInt()) needs_reload = true;
    UISettings::values.folder_icon_size = ui->folder_icon_size_combobox->currentData().toUInt();

    if (UISettings::values.row_1_text_id.GetValue() != ui->row_1_text_combobox->currentData().toUInt()) needs_reload = true;
    UISettings::values.row_1_text_id = ui->row_1_text_combobox->currentData().toUInt();

    if (UISettings::values.row_2_text_id.GetValue() != ui->row_2_text_combobox->currentData().toUInt()) needs_reload = true;
