...
#include "eden/user_data_migration.h"
...
private slots:
    ...
    void OnGameListOpenPerGameProperties(u64 title_id, const std::string& file);
...
private:
    ...
    QPushButton* res_scale_label = nullptr;
    ...
    QPushButton* dlc_button = nullptr;
    ...
    // TitleDB / DLC helper fields
    bool titledb_downloading = false;
    bool titledb_loaded = false;
    QJsonObject titledb_object;
    QNetworkAccessManager* titledb_manager = nullptr;
    QNetworkReply* titledb_reply = nullptr;
    bool titledb_dialog_pending = false;

    void StartTitleDbDownload(bool priority = false);
    void LoadTitleDbFromCache();
    void UpdateDLCButtonText();
