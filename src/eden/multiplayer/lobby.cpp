...
void Lobby::ResetModel() {
    ...
    model->setHeaderData(Column::MEMBER, Qt::Horizontal, Qt::AlignCenter, Qt::TextAlignmentRole);
    model->setHeaderData(Column::ROOM_NAME, Qt::Horizontal, Qt::AlignCenter, Qt::TextAlignmentRole);
    model->setHeaderData(Column::GAME_NAME, Qt::Horizontal, Qt::AlignCenter, Qt::TextAlignmentRole);
    model->setHeaderData(Column::HOST, Qt::Horizontal, Qt::AlignCenter, Qt::TextAlignmentRole);

    QFont bold_font;
    bold_font.setBold(true);
    model->setHeaderData(Column::MEMBER, Qt::Horizontal, QVariant::fromValue(bold_font), Qt::FontRole);
    model->setHeaderData(Column::ROOM_NAME, Qt::Horizontal, QVariant::fromValue(bold_font), Qt::FontRole);
    model->setHeaderData(Column::GAME_NAME, Qt::Horizontal, QVariant::fromValue(bold_font), Qt::FontRole);
    model->setHeaderData(Column::HOST, Qt::Horizontal, QVariant::fromValue(bold_font), Qt::FontRole);
}
