...
void EmuWindow_SDL2::SetWindowIcon() {
    SDL_RWops* const eden_icon_stream = SDL_RWFromConstMem((void*)eden_icon, eden_icon_size);
    if (eden_icon_stream == nullptr) {
        LOG_WARNING(Frontend, "Failed to create Eden icon stream.");
        return;
    }
    SDL_Surface* const window_icon = SDL_LoadBMP_RW(eden_icon_stream, 1);
