...
#include "storm_switch/multiplayer/client_room.h"
#include "storm_switch/multiplayer/lobby.h"
#include "storm_switch/multiplayer/lobby_p.h"
#include "storm_switch/multiplayer/message.h"
#include "storm_switch/multiplayer/state.h"
#include "storm_switch/multiplayer/validation.h"
...
Lobby::Lobby(QWidget* parent, QStandardItemModel* list,
    ...
    if (ui->nickname->text().isEmpty() || ui->nickname->text() == QStringLiteral("STORM SWITCH") || ui->nickname->text() == QStringLiteral("Eden")) {
        if (!Settings::values.eden_username.GetValue().empty()) {
            ...
            ui->nickname->setText(QStringLiteral("STORM SWITCH"));
        }
    }
