...
ShaderCache::ShaderCache(Tegra::MaxwellDeviceMemoryManager& device_memory_,
    ...
    : VideoCommon::ShaderCache{device_memory_}, emu_window{emu_window_}, device{device_},
      ...
      host_info{
          ...
          .max_descriptor_set_uniform_buffers_dynamic = Shader::HostTranslateInfo::DEFAULT_DESCRIPTOR_LIMIT,
          .max_descriptor_set_storage_buffers = Shader::HostTranslateInfo::DEFAULT_DESCRIPTOR_LIMIT,
          .max_descriptor_set_storage_buffers_dynamic = Shader::HostTranslateInfo::DEFAULT_DESCRIPTOR_LIMIT,
          ...
          .max_descriptor_set_input_attachements = Shader::HostTranslateInfo::DEFAULT_DESCRIPTOR_LIMIT,
