...
public:
    ...
    u32 GetMaxDescriptorSetSamplers() const {
        return properties.properties.limits.maxDescriptorSetSamplers;
    }

    u32 GetMaxDescriptorSetUniformBuffers() const {
        return properties.properties.limits.maxDescriptorSetUniformBuffers;
    }

    u32 GetMaxDescriptorSetStorageBuffers() const {
        return properties.properties.limits.maxDescriptorSetStorageBuffers;
    }
    ...
    u32 GetMaxDescriptorSetInputAttachments() const {
        return properties.properties.limits.maxDescriptorSetInputAttachments;
    }
